def is_leap_year(year):
    if year%4 == 0:
        if year%100 ==0 and year%400 != 0: #3 years per 400 surplus https://www.quora.com/Why-are-years-such-as-1700-1800-1900-not-leap-years-even-though-they-are-divisible-by-4-but-1600-and-2000-are
            return False
